module RietveldEasytrack
  module ActivityRegistration
    ...
    def self.read_activities(from_date = nil)
      tasks = []
      dir = RietveldEasytrack::Connection.read_files(RietveldEasytrack.configuration.activity_registration_read_path, from_date)
      dir ||= []
      dir.each do |file|
    ...
    def self.parse(xml)
      ...
      if as.at_xpath('.//questionnaireReport')
        q = as.xpath('.//questionnaireReport')
